...
OraSchool.controller('examsListController', function(dataFactory,$rootScope,$scope,$sce) {
    ...
    $scope.$on('$viewContentLoaded', function() {
    	if(getParameterByName('exam_id')) {
    		setTimeout(function(){
    			$scope.examDetails(getParameterByName('exam_id'))
				}, 1500);
    	}
    ...
    $scope.notify = function(id){
    		$.fallr.show({
				  buttons : {
				    button1 : {text: 'Publish', danger: true, onclick: function(){
				    	showHideLoad();
                ...
                showHideLoad(true);
				  ...
				  content : '<p>Are you sure you want to publish?</p>',
				  icon    : 'check'
				});
    }
