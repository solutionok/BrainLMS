...
OraSchool.controller('assignmentsController', function(dataFactory,$rootScope,$scope) {
    ...
    $scope.current_viewed_item = {}; // for view modal item
    $scope.viewAssignmentmodal = false;
    ...
    $scope.showAssignment = function(item) {
    ...
    $scope.viewAssignment = function(assignment){
        $scope.current_viewed_item = assignment;
        $scope.modalTitle = assignment.AssignTitle;
        $scope.viewAssignmentmodal = !$scope.viewAssignmentmodal;
    }
