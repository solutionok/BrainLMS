...
OraSchool.controller('mobileNotifController', function(dataFactory,$rootScope,$route,$sce,$scope,$location,$routeParams) {
    $scope.messages = {};
    $scope.views = {};
    $scope.form = {};
    ...
    $scope.loadNotifications = function(page){
        dataFactory.httpRequest('index.php/mobileNotif/listAll/' + page).then(function(data) {
            angular.forEach(data.items, function (item) {
                item.notifData = $sce.trustAsHtml(item.notifData);
            });
