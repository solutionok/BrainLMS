OraSchool.config(function($routeProvider,$locationProvider) {
		...
		$routeProvider.when('/mark-sheets', {
        templateUrl : 'assets/templates/mark_sheets.html',
        controller  : 'markSheetsController',
        resolve: {
		...
		$routeProvider.when('/track-buses', {
        templateUrl : 'assets/templates/track_buses.html',
        controller  : 'trackBusesController',
        resolve: {
            essentialData: function(srvLibrary) {
                return srvLibrary.getEssentials();
            }
    ...
    $routeProvider.when('/global-search', {
        templateUrl : 'assets/templates/global_search.html',
    ...
    $routeProvider.when('/vision_2020', {
        templateUrl : 'assets/templates/vision_2020.html',
    ...
    .when('/user-profile', {
        templateUrl : 'assets/templates/user-profile.html',
    ...
    .when('/pay-fee/advanced', {
        templateUrl : 'assets/templates/advanced-invoices.html',
        controller  : 'invoicesController',
        methodName: 'advancedinvoices',
        resolve: {
            essentialData: function(srvLibrary) {
                return srvLibrary.getEssentials();
            }
